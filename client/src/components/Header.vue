<template>
   <div class="wrapper d-flex align-items-stretch">
        <div class="sidebar"> 
            ...
            <h1 class="text-center"><b>VAN Thailand</b></h1></center>
            <a><router-link :to="{name: 'vans'}"><i class="fa fa-car" aria-hidden="true"></i><b> ดูข้อมูลรถบรรทุก</b></router-link></a>
            <a><router-link :to="{name: 'salevans'}"><i class="fa fa-money" aria-hidden="true"></i><b> จำหน่ายรถบรรทุก</b></router-link></a>
